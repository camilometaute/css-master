<template>
  <section>
      ...
      <div class="stripe-grid">
        <h3>Why Stripe</h3>
        <h1>A technology-first approach to payments and finance</h1>

        <div class="stripe-grid__row">
          <div class="stripe-grid__column">
            <div class="stripe-grid__column-img">
              <img src="https://image.flaticon.com/icons/svg/921/921510.svg" alt="">
            </div>
            <h5 class="stripe-grid__column-title">Close metal</h5>
