<template>
  <section>
    <div class="cookies-components">
      ...
      <!-- </div>
      <div class="cookie-light-sm">
        <font-awesome-icon icon="cookie-bite" class="overview__icon-star" /></i>
        <p>We use thir-party <a href="#">cookies</a> in order to personalize your site expierience.</p>
        <div class="cookie-light-sm__btn-container">
          <button type="button" name="button">Allow</button>
      ...
      <div class="cookie-dark-md">
        <font-awesome-icon icon="cookie-bite" class="overview__icon-star" /></i>
        <p>We use thir-party <a href="#">cookies</a> in order to personalize your site expierience.</p>
        <div class="cookie-dark-md__btn-container">
          <button type="button" name="button">Allow</button>
          <button type="button" name="button">Decline</button>
        </div> -->
      </div>
