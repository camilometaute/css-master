<template>
  <section class="card-google">
    <div class="card-google__container">
      ...
      <div class="card-google__container__content">
        <h3 class="text-title">Card google</h3>
        <span class="text-subtitle">Secondary text</span>
        <p class="text-body">Texto de prueba para estos elementos</p>
        <button class="cta">Action 1</button>
        <button class="cta">Action 2</button>
      </div>
    </div>
  </section>
</template>
